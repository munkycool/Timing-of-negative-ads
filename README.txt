...
Ad_Campaigns_List - [DEPRECATED] IDs of all election ad campaigns that included
the ad.
...
Is_Funded_By_Google_Ad_Grants - Indicates whether the ad is funded by an in-kind
donation through Google Ad Grants. This field is set to true if the advertiser
is a recipient of a Google Ad Grants in-kind donation. Google ad Grants donates
Search advertising to eligible organizations. Google does not endorse these ad.
...
on the election ad.
Spend_Range_Min_BRL - Lower bound of the amount in BRL spent by the advertiser
on the election ad.
Spend_Range_Max_BRL - Upper bound of the amount in BRL spent by the advertiser
on the election ad.
Spend_Range_Min_ARS - Lower bound of the amount in ARS spent by the advertiser
on the election ad.
Spend_Range_Max_ARS - Upper bound of the amount in ARS spent by the advertiser
on the election ad.
Spend_Range_Min_ZAR - Lower bound of the amount in ZAR spent by the advertiser
on the election ad.
Spend_Range_Max_ZAR - Upper bound of the amount in ZAR spent by the advertiser
on the election ad.
Spend_Range_Min_CLP - Lower bound of the amount in CLP spent by the advertiser
on the election ad.
Spend_Range_Max_CLP - Upper bound of the amount in CLP spent by the advertiser
on the election ad.
Spend_Range_Min_MXN - Lower bound of the amount in MXN spent by the advertiser
on the election ad.
Spend_Range_Max_MXN - Upper bound of the amount in MXN spent by the advertiser
on the election ad.
...
Spend_BRL - Total amount in BRL spent on election ads by the advertiser.
Spend_ARS - Total amount in ARS spent on election ads by the advertiser.
Spend_ZAR - Total amount in ZAR spent on election ads by the advertiser.
Spend_CLP - Total amount in CLP spent on election ads by the advertiser.
Spend_MXN - Total amount in MXN spent on election ads by the advertiser.
...
column in google-political-ads-advertiser-stats.csv.
...
the advertiser.
Spend_BRL - The amount in BRL spent on election ads during the given week by
the advertiser.
Spend_ARS - The amount in ARS spent on election ads during the given week by
the advertiser.
Spend_ZAR - The amount in ZAR spent on election ads during the given week by
the advertiser.
Spend_CLP - The amount in CLP spent on election ads during the given week by
the advertiser.
Spend_MXN - The amount in MXN spent on election ads during the given week by
the advertiser.
...
Spend_BRL - The total amount spent on election ads by the advertiser in BRL.
Spend_ARS - The total amount spent on election ads by the advertiser in ARS.
Spend_ZAR - The total amount spent on election ads by the advertiser in ZAR.
Spend_CLP - The total amount spent on election ads by the advertiser in CLP.
Spend_MXN - The total amount spent on election ads by the advertiser in MXN.
...
Spend_BRL - Total amount in BRL spent on election ads in this region.
Spend_ARS - Total amount in ARS spent on election ads in this region.
Spend_ZAR - Total amount in ZAR spent on election ads in this region.
Spend_CLP - Total amount in CLP spent on election ads in this region.
Spend_MXN - Total amount in MXN spent on election ads in this region.
...
Ads report. All dates provided are per PT time zone.
...
Advertiser_Declared_Name - The New Zealand advertiser’s declared Promoter
Statement name.
Advertiser_Declared_Address - The New Zealand advertiser’s declared Promoter
Statement address.
...
https://adstransparency.google.com/political/faq
